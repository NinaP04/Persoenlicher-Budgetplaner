...
def plot_monats_summen_pro_kategorie(kategorien_daten, budget_limits=None):
    ...
    legend_elements = [
        Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
               markerfacecolor='lightgray', markersize=10, label='Vormonat', alpha=0.6),
        Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
               markerfacecolor='green', markersize=10, label='Innerhalb Limit', alpha=0.7),
        Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
               markerfacecolor='red', markersize=10, label='Limit überschritten', alpha=0.7),
        Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
               markerfacecolor='blue', markersize=10, label='Kein Limit gesetzt', alpha=0.7),
    ]
    # Falls Budgetlimits eingezeichnet werden, ergänze das in der Legende
    if budget_limits:
        legend_elements.append(
            Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
                   markerfacecolor='#D2691E', markersize=10, label='Budgetlimit', alpha=0.8))
...
def plot_finanzziele(finanzziel_daten):
    ...
    # Einheitliche Farbe und Icons in Legende
    legend_elements = [
        plt.Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
                   markerfacecolor=to_rgba('lightblue', 0.6), markersize=10, label='Finanzziel'),
        plt.Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
                   markerfacecolor=to_rgba('green', 0.7), markersize=10, label='Ziel erreicht'),
        plt.Line2D([0], [0], color='w', marker='s', markeredgecolor='black',
                   markerfacecolor=to_rgba('red', 0.7), markersize=10, label='Ziel nicht erreicht'),
    ]
    ax.legend(handles=legend_elements, loc='upper center',
              bbox_to_anchor=(0.5, -0.15), ncol=20)
