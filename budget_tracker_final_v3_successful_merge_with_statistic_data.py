...
def statistik_menü():
    ...
    while True:
        ...
        if auswahl == "0":
            ...
            # Hier Code für Matplotlib Darstellung für Budgetlimiten einfügen
            #
            # Beispiel für spätere Verwendung:
            #   plot_monats_summen_pro_kategorie(kategorien_daten)
            #
            # Struktur von kategorien_daten:
            #   kategorien_daten[kategorie]["monate"] -> Liste "YYYY-MM"
            #   kategorien_daten[kategorie]["werte"]  -> Liste float
            #   kategorien_daten[kategorie]["farben"] -> Liste "blue"/"green"/"red"
            #   kategorien_daten[kategorie]["limit"]  -> float oder None
            #
            _ = timed_input(
            ...
            # Hier Code für Matplotlib Darstellung für Finanzziele einfügen
            #
            # Beispiel für spätere Verwendung:
            #   plot_finanzziele(finanzziel_daten)
            #
            # Struktur von finanzziel_daten:
            #   finanzziel_daten[kategorie]["ziel"]            -> float
            #   finanzziel_daten[kategorie]["ausgaben_gesamt"] -> float
            #   finanzziel_daten[kategorie]["differenz"]       -> ziel - ausgaben
            #   finanzziel_daten[kategorie]["erreicht"]        -> True/False
            #   finanzziel_daten[kategorie]["farbe"]           -> "green"/"red"
            #
            _ = timed_input(
